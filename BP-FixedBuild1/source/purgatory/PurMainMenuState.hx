...
class PurMainMenuState extends MusicBeatState
{
	...
	[
		'backgrounds/purgatory/arandomguy',
		'backgrounds/purgatory/cesars',
		'backgrounds/purgatory/cheesedjelly',
		'backgrounds/purgatory/darealmatt',
		'backgrounds/purgatory/darlyboxman',
		'backgrounds/purgatory/doodoofeces',
		'backgrounds/purgatory/fast_f00d',
		'backgrounds/purgatory/ion',
		'backgrounds/purgatory/isaaclul',
		'backgrounds/purgatory/kanandraw',
		'backgrounds/purgatory/mmimim',
		'backgrounds/purgatory/osp',
		'backgrounds/purgatory/Senza1',
		'backgrounds/purgatory/Senza2',
		'backgrounds/purgatory/slushX',
		'backgrounds/purgatory/spitz',
		'backgrounds/purgatory/tamrika',
		'backgrounds/purgatory/ultimate poop',
		'backgrounds/purgatory/ultimate poop2',
		'backgrounds/purgatory/voltrex',
		'backgrounds/purgatory/watch_out',
		'backgrounds/purgatory/zevisly',
	]; 
	...
	override function create()
	{
		...
		fuck = new FlxSprite().loadGraphic(Paths.image('purgatoryui/funny'));
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.frames = Paths.getSparrowAtlas('purmainmenu/menu_' + optionShit[i]);
		...
		logo = new FlxSprite().loadGraphic(Paths.image('bplogo'));
		logo.updateHitbox();
		logo.screenCenter();
	...
	override function update(elapsed:Float)
	{
		if (FlxG.sound.music.volume < 0.8)
		{
			...
			if(PurFreeplayState.vocals != null) PurFreeplayState.vocals.volume += 0.5 * elapsed;
		}
		...
		if (!selectedSomethin)
		{
			...
			//idk i just took this from rhythm apocalypse
