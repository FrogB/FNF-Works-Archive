...
class PurFreeplayState extends MusicBeatState
{
	...
	private var AllPossibleSongs:Array<String> = ["purgatory", "extras", "old", "joke", "mods"];
	...
	public function LoadProperPack()
		{
			switch (AllPossibleSongs[CurrentPack].toLowerCase())
			{
				case 'purgatory':
					...
					addWeek(['Fallowed'], 1, ['bambiRage']);
					addWeek(['Reality-Breaking'], 2, ['bambiGod2d']);
					addWeek(['Rebound'], 2, ['404']);
					addWeek(['Rebound V3'], 2, ['404']);
					addWeek(['Disposition', 'Disposition Alt', 'Disposition_BUT_AWESOME', 'Disposition V4', 'Upheaval-Teaser'], 2, ['bambiGod3d']);
					addWeek(['Upheaval', 'Upheaval WIP'], 2, ['god-expunged-1']);
					...
					addWeek(['Double Act'], 3, ['doubleee']);
					addWeek(["Beefin'"], 3, ['homo']);
					addWeek(['Technology'], 3, ['bombu']);
					addWeek(['Inventive'], 3, ['bombu']);
					addWeek(['Devastation'], 3, ['dagang']);
					addWeek(['Tyranny'], 4, ['expunged']);
					addWeek(['Cataclysmic'], 4, ['expunged']);
					addWeek(['Antagonism'], 4, ['ohfuck']);
				case 'extras':
					addWeek(['Defraud'], 3, ['bambi3d']);
					addWeek(['Harvested'], 3, ['bambi']);
					addWeek(['Brain Freeze'], 2, ['homo']);
					addWeek(['Fast-Food'], 2, ['bamburg_crazy']);
					addWeek(['bombu-x-bamburg-shipping-cute'], 2, ['homo']);
					addWeek(['Determined'], 1, ['tristan']);
					addWeek(['RSOD'], 4, ['bombuExpunged']);
					addWeek(['Computer'], 2, ['bombu']);
					addWeek(['Disappointment'], 2, ['gary']);
					addWeek(['Instinct'], 2, ['bombu']);
					addWeek(['sunshine'], 2, ['bandu']);
					addWeek(['Deep Fish'], 2, ['crusti']);
					addWeek(['Pepperoni'], 2, ['crusti']);
					addWeek(['Pizzeroni'], 2, ['crusti']);
					addWeek(['Reheated'], 2, ['crusturn']);
					addWeek(['Body-Destroyer'], 3, ['bambi3dUnfair']);
					addWeek(['VOLATILE'], 4, ['expunged']);
					addWeek(['Opposition'], 4, ['expunged']);
					addWeek(['Velocity'], 3, ['crimsondave']);
					addWeek(['Malware'], 3, ['bombuExpunged']);
					addWeek(['Crimson-Corridor'], 3, ['bombuExpunged']);
					addWeek(['Inflorescence'], 2, ['404']);
					addWeek(['Antagonism-Poip-Part'], 3, ['minion']);
					addWeek(['Antagonism-Test'], 3, ['bambiPISSED']);
					addWeek(['Antagonism-Expunged'], 3, ['expunged']);
					addWeek(['Deploration'], 3, ['expunged']);
					addWeek(['Dishonored'], 3, ['expunged']);
					//	#if !debug
				///	if(FlxG.save.data.idkFound)
				///	#end
				    	addWeek(['LACUNA'], 4, ['expunged']);
					addWeek(['Disregard'], 3, ['the_trio']);
					addWeek(['Dethroned'], 4, ['expunged']);
					addWeek(['Devastation-Fanmade'], 3, ['dagang']);
					addWeek(['Demise-PT-1'], 3, ['ohfuck']);
					addWeek(['Demise-PT-2'], 3, ['ohfuck']);
				case 'old':
					addWeek(['Fast-Food-Old', "Beefin' Old"], 2, ['homo']);
					addWeek(['Rebound Old'], 2, ['bambiGod']);
					addWeek(['Disposition Old'], 2, ['bambiGod3d']);
					addWeek(['Roundabout Old'], 3, ['dave']);
					addWeek(['RSOD Old'], 2, ['bombuExpunged']);
					addWeek(['Supplanted'], 1, ['bambiRage']);
					addWeek(['Supplanted-Old'], 1, ['bambiRage']);
					addWeek(['Demiurge'], 4, ['expunged']);
