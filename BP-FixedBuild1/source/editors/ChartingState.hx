...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Character', "Value 1: Character to change (Dad, BF, GF, Player 3)\nValue 2: New character's name"],
		...
		['Flash Screen VII', "Value 1: Camera to flash on (HUD, Game, Other)\nValue 2: Color of the flash\n0 - White\n1 - Black\n2 - Red\n3 - Orange\n4 - Yellow\n5 - Lime\n6 - Green\n7 - Cyan\n8 - Blue\n9 - Pink\n10 - Purple"],
		["''Dramatic'' Black and White effect", "bad apple shit lmao\nValue 1: Off/On (0/1)"],
		["funny insanity thing", "Value 2: Custom animation duration,\nleave it blank for 0.6s"],
