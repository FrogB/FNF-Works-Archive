...
class FreeplayState extends MusicBeatState
{
	...
	var bg:FlxSprite = new FlxSprite(0).loadGraphic(MainMenuState.randomizeBG());
	...
	var songColors:Array<FlxColor> = [
		...
		0xFF800080, // FESTIVAL 13
		0xFF333333, // RECURSING 14
		0xFFA296BC, // BOT TROT 15
		0xFF31323F, // MOLDY 16
		0xFF35396C, // FIVE NIGHT 17
		0xFF0162F5 // OVERDRIVE 18
    ];
	...
	public function LoadProperPack()
		{
			...
			{
				case 'dave':
					addWeek(['House'], 1, ['dave']);
					addWeek(['Insanity'], 1, ['dave-insanity']);
					addWeek(['Polygonized'], 2,['dave3d']);
					addWeek(['Blocked','Corn-Theft','Maze',], 3, ['bambi']);
					addWeek(['Splitathon'], 12,['the-duo']);
					addWeek(['Shredder', 'Greetings', 'Interdimensional', 'Rano'], 13, ['bambi', 'tristan', 'dave-festival-3d', 'dave-festival']);
				case 'old':
					addWeek(['Old-House', 'Old-Insanity'], 1, ['daveOld']);
					addWeek(['Old-Furiosity'], 2,['davesharted']);
					addWeek(['Old-Bonus-Song'], 2, ['dave']);
					addWeek(['Old-Blocked', 'Old-Corn-Theft', 'beta-maze', 'Old-Maze'], 3, ['bamberfunny']);
					addWeek(['Old-Splitathon'], 12, ['splitathon']);
				case 'joke':
                    addWeek(['Supernovae', 'Supernovae-Uber', 'Glitch', 'Vs-Dave-Thanksgiving', 'vs-dave-christmas'], 3, ['bambiJoke']);
				...
				case 'extrasandfanmades':
					addWeek(['Recursed'], 14, ['recurser']);
					addWeek(['Bonus-Song'], 1,['dave']);
					addWeek(['Furiosity'], 2, ['dave3d']);
					addWeek(['Bot-Trot'], 15, ['playrobot']);
					addWeek(['Escape-From-California'], 16, ['moldy']);
					addWeek(['Five-Nights'], 17, ['dave']);
					addWeek(['Adventure'], 8, ['tristan-opponent']);
					addWeek(['Overdrive'], 18, ['dave-awesome']);
