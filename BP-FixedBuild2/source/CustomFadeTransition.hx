...
class CustomFadeTransition extends MusicBeatSubstate {
    ...
    public function new(duration:Float, isTransIn:Bool) {
        ...
        transGradient = FlxGradient.createGradientFlxSprite(width, height, (isTransIn ? [0x0, FlxColor.BLACK] : [FlxColor.BLACK, 0x0]), 10, 1);
        transGradient.scrollFactor.set();
        add(transGradient);

        transBlack = new FlxSprite().makeGraphic(width + 400, height, FlxColor.BLACK);
