...
class ClientPrefs {
	...
	public static var rainbowFPS = true;
	public static var fastZoom:Bool = true;
	public static var devWatermark = true;
	public static var modchart = true;
	// ENDS HERE
	...
	public static function saveSettings() {
		...
		FlxG.save.data.devWatermark = devWatermark;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.devWatermark != null)
			devWatermark = FlxG.save.data.devWatermark;
