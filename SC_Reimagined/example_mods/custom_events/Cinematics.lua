...
function onCreate()
	...
	--THE TOP BAR
	makeLuaSprite('UpperBar', 'barTop', 0, -240)
	setObjectCamera('UpperBar', 'hud')
	addLuaSprite('UpperBar', false)


	--THE BOTTOM BAR
	makeLuaSprite('LowerBar', 'barBottom', 0, 240)
...
function onUpdate()
	...
	doTweenY('Cinematics1', 'UpperBar', -45, 0.5, 'Linear')
	doTweenY('Cinematics2', 'LowerBar', 45, 0.5, 'Linear')
	...
	doTweenAlpha('AlphaTween9', 'healthBarOverlay', 0, 0.25)
	...
	doTweenY('Cinematics2', 'LowerBar', 240, 0.5, 'Linear')
	...
	doTweenAlpha('AlphaTween9', 'healthBarOverlay', 1, 0.25)
