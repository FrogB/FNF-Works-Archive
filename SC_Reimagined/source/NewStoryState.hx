...
class NewStoryState extends MusicBeatState
{
	...
	override function create()
	{
		...
		WeekData.reloadWeekFiles(true); //trying something a lil' different.
		...
		week1 = new FlxSprite(100, 70).loadGraphic(Paths.image('weeks/story1'));
		week1.scale.set(0.8, 0.8);
		week1.updateHitbox();
		week1.antialiasing = ClientPrefs.globalAntialiasing;
		menuItems.add(week1);
		
		week1text = new FlxText(80, 480, 320, "The\n" + "Beginning\n");
		...
		week2 = new FlxSprite(500, 70).loadGraphic(Paths.image('weeks/story2'));
		week2.scale.set(0.8, 0.8);
		week2.updateHitbox();
		week2.antialiasing = ClientPrefs.globalAntialiasing;
		menuItems.add(week2);
		
		week2text = new FlxText(480, 480, 320, "Farm\n" + "Feud\n");
		...
		week3 = new FlxSprite(900, 70).loadGraphic(Paths.image('weeks/story3'));
		week3.scale.set(0.8, 0.8);
		week3.updateHitbox();
		week3.antialiasing = ClientPrefs.globalAntialiasing;
		menuItems.add(week3);
		
		week3text = new FlxText(880, 480, 320, "Expunged's\n" + "Dimension\n");
	  ...
	  override public function update(elapsed:Float)
	  {
		...
		if (clicked)
		{
			...
			startSong4('sweetcorn/sweetcorn', 'cob');	
		}
		...
		if (clicked2)
		{
			lol2 = true;
			FlxG.sound.play(Paths.sound('confirmMenu'));
			startSong2('dismantle/dismantle', 'blistering', 'tenacity');	
		}
		...
		if (clicked3)
		{
			lol3 = true;
			FlxG.sound.play(Paths.sound('confirmMenu'));
			startSong3('tachophobia/tachophobia', 'deceit', 'pleasured', 'resistance', 'harawotateru', 'exasperation');	
		}
	...
	function startSong3(songName1:String, songName2:String, songName3:String, songName4:String, songName5:String, songName6:String)
    {
	   FlxFlicker.flicker(week3, 1, 0.06, false, false, function(flick:FlxFlicker)
	   {
	    PlayState.storyPlaylist = [songName1, songName2, songName3, songName4, songName5, songName6];
		PlayState.isStoryMode = true;
	...
	function startSong4(songName1:String, songName2:String)
    {
...
class Section2Substate extends MusicBeatSubstate
{
	...
	public function new() {
		...
		week4text = new FlxText(80, 480, 320, "\n" + "???\n");
		...
		week5text = new FlxText(480, 480, 320, "Hell\n" + "Week\n");
		...
		week6text = new FlxText(880, 480, 320, "Hell\n" + "Week\n");
