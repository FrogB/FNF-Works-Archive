...
{
	public static var curModVer:String = '1.5';
	...
	override function create()
	{
        ...
        var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 64, 0, "Strident Crisis - REIMAGINED " + curModVer, 12);
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				else
				{
					...
					{
						FlxTween.tween(FlxG.camera, {angle: 45}, 1, {ease: FlxEase.expoIn});
					});
