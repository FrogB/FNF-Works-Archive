...
class FreeplayState extends MusicBeatState
{
	...
	var thekeys:Array<String> = ['B','SHIFT'];
	...
	override function create()
	{
		...
		WeekData.reloadCustomWeekFiles(FreeplayCatState.categorySelected, false); //this will load the category songs !111
	...
	override function update(elapsed:Float)
	{
		...
		if(thekeys[0] == 'SHIFT')
			{
				PlayState.SONG = Song.loadFromJson("debugged", "debugged"); //fuck why did it say b
		...
		if (FlxG.keys.anyPressed([thekeys[0]]))
			{
					trace("What The Fuck Is That The Real The "+thekeys[0]);
